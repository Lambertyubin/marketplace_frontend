...
const create = async (params, credentials, order, token) => {
  try {
    let response = await fetch(
      config.apiHost + "/api/orders/" + params.userId,
      {
        method: "POST",
        headers: {
...
const listByShop = async (params, credentials, signal) => {
  try {
    let response = await fetch(
      config.apiHost + "/api/orders/shop/" + params.shopId,
      {
        method: "GET",
        signal: signal,
        headers: {
...
const update = async (params, credentials, product) => {
  try {
    let response = await fetch(
      config.apiHost + "/api/order/status/" + params.shopId,
      {
        method: "PUT",
        headers: {
          Accept: "application/json",
...
const getStatusValues = async (signal) => {
  try {
    let response = await fetch(config.apiHost + "/api/order/status_values", {
      method: "GET",
      signal: signal,
    });
    return response.json();
...
const listByUser = async (params, credentials, signal) => {
  try {
    let response = await fetch(
      config.apiHost + "/api/orders/user/" + params.userId,
      {
        method: "GET",
        signal: signal,
        headers: {
...
const read = async (params, credentials, signal) => {
  try {
    let response = await fetch(
      config.apiHost + "/api/order/" + params.orderId,
      {
        method: "GET",
        signal: signal,
      }
